...
HD_PWD='C:/Users/ZaG/Desktop/vivado_project/final/final/final.runs/Vga_25MH_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vga_25MH.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vga_25MH.tcl
