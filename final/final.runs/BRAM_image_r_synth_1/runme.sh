...
HD_PWD='C:/Users/ZaG/Desktop/vivado_project/final/final/final.runs/BRAM_image_r_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_image_r.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_image_r.tcl
