...
HD_PWD='C:/Users/ZaG/Desktop/vivado_project/final/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mp3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mp3.tcl -notrace
