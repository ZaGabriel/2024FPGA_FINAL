...
HD_PWD='C:/Users/ZaG/Desktop/vivado_project/final/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mp3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mp3.tcl
